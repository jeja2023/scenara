...
test "$output_dir" != "/"
tag="${SCENARA_IMAGE_TAG:-0.3.0-dev.43}"
...
cp "$repo_root/LICENSE" "$repo_root/NOTICE" "$repo_root/第三方声明.md" "$staging/"
cp "$repo_root/模型资产政策.md" "$repo_root/source-manifest.json" "$staging/"
