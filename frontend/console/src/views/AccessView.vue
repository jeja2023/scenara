...
const defaultProductsList: DisplayProduct[] = [
  {
    id: "parse",
    name: "智能视觉与文档解析",
    domain: "视觉解析与OCR",
...
input.search-input {
  ...
  box-sizing: border-box !important;
  transition: width 0.2s ease, border-color 0.15s ease, box-shadow 0.15s ease !important;
}

input.search-input:focus {
  width: 220px !important;
  border-color: var(--color-accent, #087682) !important;
  box-shadow: 0 0 0 2px var(--color-accent-soft, #e4f1f1) !important;
