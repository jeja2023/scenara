        ...
        return (
            PipelineDefinition(
                ...
                parameter_schema={
                    ...
                    "custom_sensitive_words": PipelineParameterDefinition(
                        label="自定义敏感词",
                        control="text",
                        default="",
                        advanced=True,
                        placeholder="逗号或换行分隔，如: 内部绝密, 商业机密",
                        description="业务自定义检测词库，支持逗号、分号或换行分隔（命中将违规阻断）",
                    ),
                    "compliance_whitelist": PipelineParameterDefinition(
                        label="合规豁免白名单",
                        control="text",
                        default="",
                        advanced=True,
                        placeholder="逗号或换行分隔，如: 第一人民医院, 第一分公司",
                        description="业务合法词汇/机构名豁免白名单，支持逗号或换行分隔（命中将放行不予报错）",
                    ),
