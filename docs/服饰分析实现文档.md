...
**文件**: `scenara/domains/fashion/reference_adapter.py`
...
SCENARA_FASHION_ENGINE_FACTORY=scenara.domains.fashion.reference_adapter:create_reference_fashion_engine
