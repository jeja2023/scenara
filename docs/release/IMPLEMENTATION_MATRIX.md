...
Current development version: `0.3.0-dev.13` (`0.3.0.dev13` for Python packages).
This version is an engineering qualification snapshot, not a `1.0.0` production release.

The `0.3.0-dev.13` engineering baseline cumulatively adds domain-scoped Parse
...
The `0.3.0-dev.13` hardening also closes empty-scope/product authorization paths,
